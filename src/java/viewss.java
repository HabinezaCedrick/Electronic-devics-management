...
public class viewss extends HttpServlet {
...
"\n" );
            out.println("<div class=\"button_section\"> <a class=\"main_bt\" href=\"indexx.html\" style=\"font:600 18px/20px 'Open Sans',sans-serif;\">RETURN</a>  </div>");
            
            
            response.setHeader("Refresh", timeout + "; URL=loginout.html");
            out.close();
